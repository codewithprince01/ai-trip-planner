...
function PlaceCard({ place }) {
  return (
    ...
    >
      <div className="border rounded-xl p-5 mt-5 flex flex-col sm:flex-row gap-5 shadow-sm bg-white hover:border-teal-500 cursor-pointer">
        <img
          src='/images/aeroplane.avif'
          alt={place.name}
          className='w-full sm:w-[150px] h-[150px] sm:h-[150px] rounded-xl object-cover transition-transform duration-300 ease-in-out'
        />
