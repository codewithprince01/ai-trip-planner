    ...
    <div className="my-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 justify-items-center">
        {trip?.tripData?.hotel_options?.map((hotel, index) => (
          ...
          >
            <div className="bg-white rounded-lg shadow-xl hover:shadow-2xl overflow-hidden max-w-sm w-full h-[500px] flex flex-col">
              <div className="relative w-full flex-shrink-0 h-64">
                <img
                  src="/images/aeroplane.avif" // Replace with hotel image URL if available
                  alt={hotel.name}
